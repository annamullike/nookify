      ...
      <div className="contentBox">
        {recNames.length > 0 ? (
          ...
          <div className="splash">
            ...
            {token === "" ? <div><p>Sign in with Spotify to get started!</p><div className="authButton"><AuthButton /></div></div>  : <div>Toggle the sidebar to get your personalized music!</div>}
              </div>
